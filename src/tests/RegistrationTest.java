...
public class RegistrationTest extends BasicTest {
	...
	public void RegistrationBookingForMyself() throws InterruptedException {
		...
		rp.bookingForMyself(false, true, true, true, false, "Home Clinic", "New York", "123", "56789", "no", true);
	...
	public void RegistrationBookingForSomeoneElse() throws InterruptedException {
		...
		// Booking
		rp.setRegistrationInfo("Ms", "Dummy", "User", "01/01/1980", "dummyemail2@email.com", "password123", "381",
				"123456789", "Someone else");

		Thread.sleep(1000);

		rp.bookingForSomeoneElse("Mrs", "Dummy", "Patient", "16/06/1965", "patient@email.com", "123", "123456", false,
				true, true, false, false, "Home Clinic", "LA", "123", "123456", "yes", true);
	...
	public void RegistrationBookingForBoth() throws InterruptedException {
		...
		// Booking
		rp.setRegistrationInfo("Ms", "Dummy", "User", "01/01/1980", "dummyemail3@email.com", "password123", "381",
				"123456789", "Both");
